...
public class Oval extends Shape
{
     ...
     * polygon, this array defines the corners. There are no corners here, but
     * we need to store the center point of the oval. We can simply use the
     * location array and rely on this knowledge to draw the oval.
     * 
     * @param pointCenter
    ...
    /**
     * This method takes a graphics object to perform the drawing, places the
     * points of the oval and fills it with the color if filled is true.
     * 
     ...
     * oval. You will need to do a small amuont of math to determine the
     * top-left corner of the bounding box given the center point that you
     * should have stored.
     * 
     * @param graphics
    ...
    public void draw(Graphics graphics)
    {
        ...
        // TODO: define how to draw an oval. Remember that the point stored is
        // the center point.
        if (this.isFilled())
        {
